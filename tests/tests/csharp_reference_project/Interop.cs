...
namespace My.Company
{
    public static partial class Interop
    {
        ...
        static Interop()
        {
            ...
            if (api_version != 0x9a547f46b97334e3)
            {
                throw new TypeLoadException($"API reports hash 0x{api_version:X} which differs from hash in bindings (0x9a547f46b97334e3). You probably forgot to update / copy either the bindings or the library.");
            }
        }
        ...
        [LibraryImport(NativeLib, EntryPoint = "service_async_handle_vec_string")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial ResultError service_async_handle_vec_string(IntPtr _context, VecUtf8String s, AsyncCallbackCommonNative _async_callback);

        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static unsafe Task<VecUtf8String> service_async_handle_vec_string(IntPtr _context, VecUtf8String s)
        {
            var (_cb, _cs) = _trampolineResultVecUtf8StringError.NewCall();
            try
            {
                service_async_handle_vec_string(_context, s, _cb).AsOk();
                return _cs;
            }
            finally
            {
    ...
    public partial class ServiceAsync : IDisposable
    {
        ...
        {
            return Interop.service_async_handle_vec_string(_context, s);
        }
